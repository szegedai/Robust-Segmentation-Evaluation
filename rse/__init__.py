...
def build_attacks(attack_names, num_classes, eps=8 / 255):
    attacks = {
        ...
        'mask-ce-avg-apgd': partial(apgd_restarts, n_iter=300, n_restarts=1, use_rs=True, loss='mask-ce-avg', track_loss='ce-avg', eps=eps),
        'segpgd-loss-apgd': partial(apgd_restarts, n_iter=300, n_restarts=1, use_rs=True, loss='segpgd-loss', track_loss='ce-avg', eps=eps),
        'js-avg-apgd': partial(apgd_restarts, n_iter=300, n_restarts=1, use_rs=True, loss='js-avg', track_loss='ce-avg', eps=eps),
        'mask-norm-corrlog-avg-apgd': partial(apgd_restarts, n_iter=300, n_restarts=1, use_rs=True, loss='mask-norm-corrlog-avg', track_loss='mask-norm-corrlog-avg', eps=eps),
